...
Вы можете скачать готовую версию приложения в формате .exe из раздела [Releases](https://github.com/JustDev-oper/Qt_Launcher/releases). Просто скачайте архив, распакуйте и запустите `QtLauncher.exe` — зависимости устанавливать не нужно!
